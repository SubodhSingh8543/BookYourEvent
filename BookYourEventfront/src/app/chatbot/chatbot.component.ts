...
export class ChatbotComponent {
  ...
  //       .post('https://ill-red-crane-ring.cyclic.app/chat', { message: this.userMessage })
  //       .toPromise();

  //     // Update bot message in the state
  //     this.botMessage = response.message;
  //   } catch (error) {
  //     console.error('Error:', error);
  //   }

  //   // Clear user message from the input field
  //   this.userMessage = '';
  // }
