...
//     const apiUrl = `http://127.0.0.1:11000/movies?page=${this.currentPage}&page_size=${this.itemsPerPage}&title=${title}`;
...
//   redirectToShows(movieId: string, moviePoster: string) {
//     // Append the movie ID and poster URL as query parameters in the URL and navigate to the "shows" route
//     this.router.navigate(['/shows'], { queryParams: { movie_id: movieId, poster: moviePoster } });
//   }
// }
